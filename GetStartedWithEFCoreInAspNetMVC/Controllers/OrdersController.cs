...
namespace GetStartedWithEFCoreInAspNetMVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,OrderDate,CustomerID,OrderState")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,OrderDate,CustomerID,OrderState")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
